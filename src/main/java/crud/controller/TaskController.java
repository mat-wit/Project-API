...
import crud.domain.TaskDto;
import crud.mapper.TaskMapper;
import crud.service.DbService;
...
public class TaskController {
    ...
    public TaskDto getTask(@RequestParam(value = "id") Long taskId) throws TaskNotFoundException {
